...
void DrawCity()
{
   ...
   ///================================ Left most Building
    ...
    glEnd();
    glColor3f(0, 153, 0);   //tree leaf color
    draw_circle(30,490,20);     //tree  top 1st leaf
    draw_circle(60,490,20);     //tree top 2nd leaf
    draw_circle(38,510,18);     //tree middle 1st leaf
    draw_circle(52,510,18);     //tree middle 2nd leaf
    draw_circle(45,535,14);     //tree top leaf
